...
####################################################################################################################
customer_operator.register_stateful_functions(customer.Insert)
district_operator.register_stateful_functions(district.Insert)
history_operator.register_stateful_functions(history.Insert)
item_operator.register_stateful_functions(item.Insert)
new_order_operator.register_stateful_functions(new_order.Insert)
order_operator.register_stateful_functions(order.Insert)
order_line_operator.register_stateful_functions(order_line.Insert)
stock_operator.register_stateful_functions(stock.Insert)
warehouse_operator.register_stateful_functions(warehouse.Insert)
