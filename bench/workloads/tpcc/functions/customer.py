...
from workloads.tpcc.functions import order, new_order, stock, order_line
...
class NewOrder(StatefulFunction):
    async def run(self, key: str, params: dict):
        ...
        tasks.append(self.call_remote_async(order.Insert, order_key, (order_key, order_params,)))
