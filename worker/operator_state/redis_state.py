...
class RedisOperatorState(BaseOperatorState):
    ...
    def __init__(self, db: int = 0):
        ...
        self.writing_to_db_lock = asyncio.Lock()

    async def put(self, key, value, t_id: int):
        logging.info(f'PUT: {key}:{value} with t_id: {t_id}')
